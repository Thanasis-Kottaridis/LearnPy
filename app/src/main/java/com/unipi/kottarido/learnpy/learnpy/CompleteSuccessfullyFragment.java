...
public class CompleteSuccessfullyFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(getArguments() != null){
            ...
            userScore = getArguments().getInt(CourseActivity.USER_SCORE_KEY);

        }

        // provalei ta apotelesmata sta views
        descriptionTextView.setText("You have completed the course "+courseTitle+" successfully!");
        scoreTextView.setText("COURSE SCORE: "+ String.valueOf(userScore));
